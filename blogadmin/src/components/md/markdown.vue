<template>
    <div class="mdContainer" :class="{ fullPage: fullPageStatus }">
        <div class="navContainer" v-if="navStatus">
            ...
            <div class="pulishwrapper">
              <el-tooltip content="保存草稿" placement="top">
                <i @click="draft" class="fa fa-save"></i>
              </el-tooltip>
              <button @click="pulishArticle" class="pulishButton"><i class="fa fa-share"></i>发布文章</button>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            pulishArticle() {
              this.$emit('pulishArticle')
            },
            cancel() {
              this.showChooseImage = false
            },
            uploadSuccess(imageUrlArr) {
              this.showChooseImage = false

              imageUrlArr.forEach((item) => {
                insertContent('![Vue](' + item + ')', this)
              })
            },
            tabFn: function(evt) {
                insertContent('    ', this)
...
<style lang="scss">
  ...
  .mdContainer {
    ...
    .pulishwrapper .fa-share {
    }
    .pulishwrapper .pulishButton {
