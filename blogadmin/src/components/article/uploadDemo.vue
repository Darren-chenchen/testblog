  ...
  export default {
    ...
    methods: {
      ...
      beginLoad() {
        ...
        axios.post(`admin/uploadzip`, data, config)
          .then((res) => {
            console.log(res)
            Message({
            ...
            let url = this.axios.defaults.baseURL + res.data.data
...
<style lang="scss">
  ...
  .uploadDemo-wrapper .uploadContent {
    position: absolute;
    width: 240px;
    height: 240px;
  ...
  .uploadDemo-wrapper .uploadContent img {
    margin-top: 95px;
  }
</style>
